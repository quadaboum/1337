...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL')  # Railway/Postgres only!
...
def missions():
    user = current_user()
    # missions = []  # à personnaliser si tu veux charger dynamiquement plus tard
...
def boutique():
    user = current_user()
    # objets = []  # à personnaliser si tu veux charger dynamiquement plus tard
